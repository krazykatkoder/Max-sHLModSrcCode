...
import net.mcreator.hl.procedures.RPGFRAGPlayerFinishesUsingItemProcedure;

public class RPGFRAGItem extends Item {
	public RPGFRAGItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		RPGFRAGPlayerFinishesUsingItemProcedure.execute(world);
		return retval;
	}
}
