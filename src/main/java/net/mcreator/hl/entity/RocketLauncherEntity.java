...
import net.mcreator.hl.procedures.RocketLauncherProjectileHitsBlockProcedure;
...
public class RocketLauncherEntity extends AbstractArrow implements ItemSupplier {
	public RocketLauncherEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(HlmodModEntities.ROCKET_LAUNCHER.get(), world);
	}
	...
	public ItemStack getItem() {
		return new ItemStack(HlmodModItems.RPGROCKET.get());
	}
	...
	public static RocketLauncherEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		RocketLauncherEntity entityarrow = new RocketLauncherEntity(HlmodModEntities.ROCKET_LAUNCHER.get(), entity, world);
	...
	public static RocketLauncherEntity shoot(LivingEntity entity, LivingEntity target) {
		RocketLauncherEntity entityarrow = new RocketLauncherEntity(HlmodModEntities.ROCKET_LAUNCHER.get(), entity, entity.level());
